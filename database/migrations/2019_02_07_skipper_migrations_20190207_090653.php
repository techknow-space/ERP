...
/* Migration id: a19d25a7-efab-40a1-b30b-0a5b1942f19a */
/* Migration datetime: 2019-02-07 09:06:53.956943 */

use Illuminate\Support\Facades\Schema;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Database\Migrations\Migration;

class Migrations20190207090653 extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  */
  public function up()
  {
    ...
    Schema::create('devices', function (Blueprint $table) {
      $table->uuid('id')->unique()->unsigned();
      $table->char('model_name',500)->unique();
      $table->multiLineString('details')->nullable(true);
      $table->uuid('brand_id')->nullable(true)->unsigned();
      $table->uuid('deviceType_id')->nullable(true)->unsigned();
    ...
    Schema::create('parts', function (Blueprint $table) {
      ...
      $table->multiLineString('details')->nullable(true);
      $table->uuid('partCategory_id')->nullable(true)->unsigned();
      $table->uuid('partStatus_id')->nullable(true)->unsigned();
      $table->uuid('partType_id')->nullable(true)->unsigned();
      $table->uuid('partColour_id')->nullable(true)->unsigned();
      $table->uuid('device_id')->nullable(true)->unsigned();
    ...
    Schema::create('part_stocks', function (Blueprint $table) {
      ...
      $table->integer('stock_qty')->nullable(true)->default(0);
      $table->uuid('location_id')->nullable(true)->unsigned();
    ...
    Schema::create('part_prices', function (Blueprint $table) {
      $table->uuid('id')->unique()->unsigned();
      $table->uuid('part_id')->nullable(true)->unsigned();
